...
namespace Lab14
{
    public partial class Form1 : Form
    {
        ...
        private void freq(BTN Alhoritm)
        {
            ...
            label6.Text = "Время выполнения алгоритма: " + stat.sw.ElapsedMilliseconds.ToString() + "ms";
            stat.MeanAvailable();
            label4.Text = "Эмпирическое Мат.Ожидание: " + stat.E + " (Относительная погрешность = " + stat.EErr + " %)";
            label5.Text = "Эмпирическая дисперсия: " + stat.D + " (Относительная погрешность = " + stat.DErr + " %)";
        ...
        class Statistica
        {
            ...
            {
                if ((double)Chi < 11.07) return "Критерий Хи-Квадрат: " + Math.Round((double)Chi, 3) + " < 11.07 выполнен";
                return "Критерий Хи-Квадрат: " + Math.Round((double)Chi, 3) +  " > 11.07 не выполнен";
            }
